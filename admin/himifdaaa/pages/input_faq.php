...
<h1>Isi datamu!<span>Form ini untuk mengirim pertanyaan terkait Informatika UNSADA dan Himifda</span></h1>
<form  method="post" action="config/simpan_faq.php">
 
  <input type="hidden" name="id">

    <div class="section"><span>1</span>FaQ</div>
    <div class="inner-wrap">
        <label>Pertanyaan<input type="text" name="question" /></label>
        <label>Jawaban <input type="text" name="answer" /></label>
