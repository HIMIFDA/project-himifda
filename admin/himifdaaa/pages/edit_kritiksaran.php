...
$edit    = "SELECT id, email, kritik, saran FROM kritiksaran WHERE id = '$id'";
...
<form  method="post" action="config/simpan_kritiksaran.php">
  ...
  <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
    ...
    <div class="inner-wrap">
        <label>e-mail<input type="email" name="email"  value="<?php echo $data['email']; ?>"/></label>
    ...
    <div class="section"><span>2</span>Kritik & Saran</div>
    <div class="inner-wrap">
