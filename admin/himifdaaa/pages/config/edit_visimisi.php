...
$visi = $_POST['visi']; // Ambil data nama dan masukkan ke variabel nama
$misi = $_POST['misi'];
...
$edit = mysqli_query($connect,"UPDATE visimisi SET id='$id', visi='$visi', misi='$misi' WHERE id='$id'");

echo "Data telah berhasil diedit.";
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=data_visimisi">';			
