...
$kode_event = $_POST['kode_event']; // Ambil data nama dan masukkan ke variabel nama
$tgl = $_POST['tgl'];
...
$edit = mysqli_query($connect,"UPDATE kegiatan SET id='$id', kode_event='$kode_event', tgl='$tgl', nama_kegiatan='$nama_kegiatan', bidang='$bidang', gambar='$gambar', deskripsi='$deskripsi', kegiatan='$kegiatan' WHERE id='$id'");
