...
$kode_berita = $_POST['kode_berita']; // Ambil data nama dan masukkan ke variabel nama
$tgl = $_POST['tgl'];
$judul = $_POST['judul'];
$foto = $_POST['foto'];
...
$edit = mysqli_query($connect,"UPDATE berita SET id='$id', kode_berita='$kode_berita', tgl='$tgl', judul='$judul', foto='$foto', read_more='$read_more', deskripsi='$deskripsi' WHERE id='$id'");
