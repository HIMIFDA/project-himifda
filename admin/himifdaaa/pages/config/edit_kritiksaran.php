...
$email = $_POST['email']; // Ambil data nama dan masukkan ke variabel nama
$kritik = $_POST['kritik'];
$saran = $_POST['saran'];
...
$edit = mysqli_query($connect,"UPDATE ipk SET id='$id', email='$email', kritik='$kritik', saran='$saran' WHERE id='$id'");
