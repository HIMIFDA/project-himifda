...
<h1>Simpan Foto<span>Form ini untuk menyimpan foto struktural Himifda</span></h1>
<form enctype="multipart/form-data" method="POST" action="proses.php">
  ...
  <input type="hidden" name="id">
    ...
    <div class="inner-wrap">
        <label>Struktural<input type="file" name="fupload"></label>
        <textarea name="deskripsi" rows="8" cols="40" placeholder="Deskripsi FIle.."></textarea>
