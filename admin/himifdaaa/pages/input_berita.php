...
<h1>Simpan Foto<span>Form ini untuk menyimpan berita Himifda</span></h1>
<form enctype="multipart/form-data" method="POST" action="proses.php">
  ...
  <input type="hidden" name="id">
    ...
    <div class="inner-wrap">
        <label>Kode berita <input type="text" name="kode_berita"></label>
        <label>Tanggal <input type="date" name="tgl"></label>
        <label>Judul <input type="text" name="judul"></label>
        <label>Foto<input type="file" name="fupload"></label>
        <label>Read More<input type="date" name="tgl"></label>
        <label>Tanggal <input type="date" name="tgl"></label>
        <label>Deskripsi <textarea name="deskripsi" rows="8" cols="40" placeholder="Deskripsi FIle.."></textarea></label>
