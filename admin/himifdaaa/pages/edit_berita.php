...
$edit    = "SELECT id, kode_berita, tgl, judul, foto,read_more,deskripsi  FROM berita WHERE id = '$id'";
...
<form  method="post" action="config/edit_berita.php">
 
  <input type="hidden" name="id"  value="<?php echo $data['id']; ?>">

    <div class="section"><span>1</span>Berita</div>
    <div class="inner-wrap">
        <label>Kode Berita<input type="text" name="kode_berita"  value="<?php echo $data['kode_berita']; ?>"/></label>
        <label>Tanggal<input type="date" name="tgl"  value="<?php echo $data['tgl']; ?>"/></label>
        <label>Judul<input type="text" name="judul"  value="<?php echo $data['judul']; ?>"/></label>
        <label>Foto<input type="file" name="foto"  value="<?php echo $data['foto']; ?>"/></label>
        <label>Read More<input type="text" name="read_more"  value="<?php echo $data['read_more']; ?>"/></label>
