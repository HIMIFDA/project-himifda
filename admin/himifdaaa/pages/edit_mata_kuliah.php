...
$edit    = "SELECT id, semester, mata_kuliah, bobot_sks  FROM mata_kuliah WHERE id = '$id'";
...
<form  method="post" action="config/edit_mata_kuliah.php">
 
  <input type="hidden" name="id" value="<?php echo $data['id']; ?>">

    <div class="section"><span>1</span></div>
    <div class="inner-wrap">
        <label>Semester<input type="text" name="kegiatan"  value="<?php echo $data['semester']; ?>"/></label>
        <label>Mata Kuliah<input type="text" name="mata_kuliah" value="<?php echo $data['mata_kuliah']; ?>"/></label>
        <label>Bobot SKS <input type="text" name="bobot_sks" value="<?php echo $data['bobot_sks']; ?>"/></label>
