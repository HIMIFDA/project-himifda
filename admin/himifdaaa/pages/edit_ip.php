...
$edit    = "SELECT id, nama, nim, semester, ips,ipk FROM ipk WHERE id = '$id'";
...
<div class="section"><span>3</span>IP</div>
 <div class="inner-wrap">
        <label>IPS <input type="text" name="ips"  value="<?php echo $data['ips']; ?>"/></label>
        <label>IPK <input type="text" name="ipk"  value="<?php echo $data['ipk']; ?>"/></label>
    </div>
