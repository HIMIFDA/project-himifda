...
$edit    = "SELECT id, foto, caption FROM galery WHERE id = '$id'";
...
<h1>Simpan Foto<span>Form ini untuk menyimpan foto terkait Informatika UNSADA dan Himifda</span></h1>
<form action="../config/upload.php" method="POST" enctype="multipart/form-data">
 
  <input type="hidden" name="id">

    <div class="section"><span>1</span>Galery</div>
    <div class="inner-wrap">
        <label>Gambar<input type="file" name="foto" value="<?php echo $data['foto']; ?>"/></label>
        <label>Caption <input type="text" name="caption" value="<?php echo $data['caption']; ?>"/></label>
