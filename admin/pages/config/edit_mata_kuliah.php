...
$edit = mysqli_query($connect,"UPDATE mata_kuliah SET id='$id', semester='$semester', mata_kuliah='$mata_kuliah', bobot_sks='$bobot_sks' WHERE id='$id'");

echo "Data telah berhasil diedit.";
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=data_mata_kuliah">';			
