...
$kegiatan = $_POST['kegiatan']; // Ambil data nama dan masukkan ke variabel nama
...
$edit = mysqli_query($connect,"UPDATE faq SET id='$id', kegiatan='$kegiatan', tgl_mulai='$tgl_mulai', tgl_selesai='$tgl_selesai', keterangan='$keterangan', libur='$libur' WHERE id='$id'");

echo "Data telah berhasil diedit.";
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=data_kalender_akademik">';			
