...
$edit = mysqli_query($connect,"UPDATE modul SET id='$id', Semester='$Semester', Mata_Kuliah='$Mata_Kuliah', Judul_Materi='$Judul_Materi', file='$file' WHERE id='$id'");

echo "Data telah berhasil diedit.";
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=data_data_modul">';			
