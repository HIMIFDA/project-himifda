...
$question = $_POST['question']; // Ambil data nama dan masukkan ke variabel nama
$answer = $_POST['answer'];
...
$edit = mysqli_query($connect,"UPDATE faq SET id='$id', question='$question', answer='$answer' WHERE id='$id'");
