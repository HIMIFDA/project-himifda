...
$sejarah = $_POST['sejarah']; // Ambil data nama dan masukkan ke variabel nama
...
$edit = mysqli_query($connect,"UPDATE sejarah SET id='$id', sejarah='$sejarah' WHERE id='$id'");

echo "Data telah berhasil diedit.";
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=data_sejarah">';			
