...
$foto = $_POST['foto']; // Ambil data nama dan masukkan ke variabel nama
...
$edit = mysqli_query($connect,"UPDATE galery SET id='$id', foto='$foto', caption='$caption' WHERE id='$id'");

echo "Data telah berhasil diedit.";
echo '<META HTTP-EQUIV="REFRESH" CONTENT ="1; url=../index.php?halaman=data_galery">';			
