...
$edit = mysqli_query($connect,"UPDATE alumni SET id='$id', nim='$nim', nama='$nama', angkatan='$angkatan', jk='$jk', alamat='$alamat', no_hp='$no_hp', email='$email', tempat_lahir='$tempat_lahir', tgl_lahir='$tgl_lahir', agama='$agama'WHERE id='$id'");
