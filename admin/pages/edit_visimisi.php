...
$edit    = "SELECT id, visi, misi FROM visimisi WHERE id = '$id'";
...
<h1>Visi Misi Himifda<span></span></h1>
<form  method="post" action="config/edit_visi_misi.php">
 
  <input type="hidden" name="id"  value="<?php echo $data['id']; ?>">

    <div class="section"><span>1</span>Visi Misi</div>
    <div class="inner-wrap">
        <label>Visi<input type="text" name="visi"  value="<?php echo $data['visi']; ?>"/></label>
        <label>Misi <input type="text" name="misi"  value="<?php echo $data['misi']; ?>"/></label>
