...
$edit    = "SELECT id, sejarah FROM sejarah WHERE id = '$id'";
...
<h1>Sejarah Himifda<span></span></h1>
<form  method="post" action="config/edit_sejarah.php">
 
  <input type="hidden" name="id"  value="<?php echo $data['id']; ?>">

    <div class="section"><span>1</span>Sejarah</div>
    <div class="inner-wrap">
        <label>Sejarah<input type="text" name="question"  value="<?php echo $data['sejarah']; ?>"/></label>
