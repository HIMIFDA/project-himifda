...
<form  method="post" action="config/edit_info_beasiswa.php">
  ...
  <input type="hidden" name="id"  value="<?php echo $data['id']; ?>">
    ...
    <div class="inner-wrap">
        ...
        <label>Penyelenggara<input type="text" name="penyelenggara"  value="<?php echo $data['foto']; ?>"/></label>
        <label>File<input type="file" name="file"  value="<?php echo $data['read_more']; ?>"/></label>
