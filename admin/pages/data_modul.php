<div class="alert alert-info">
  <strong>DATA Modul </strong>&nbsp; Himpunan Informatika Universitas Darma Persada
</div>
        <!-- /.col -->
    ...
    <?php
                        ...
                        $query = mysqli_query($connect, "SELECT id, Semester, Mata_Kuliah, Judul_Materi, file  FROM modul")or die(mysqli_error($connect));
