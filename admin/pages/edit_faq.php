...
$edit    = "SELECT id, question, answer FROM faq WHERE id = '$id'";
...
<h1>FaQ<span></span></h1>
<form  method="post" action="config/edit_faq.php">
 
  <input type="hidden" name="id"  value="<?php echo $data['id']; ?>">

    <div class="section"><span>1</span>FaQ</div>
    <div class="inner-wrap">
        <label>Pertanyaan<input type="text" name="question"  value="<?php echo $data['question']; ?>"/></label>
        <label>Jawaban <input type="text" name="answer"  value="<?php echo $data['answer']; ?>"/></label>
